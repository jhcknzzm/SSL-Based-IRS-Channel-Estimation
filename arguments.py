...
def get_args():
    ...
    parser.add_argument('--num_train_data', type=int, default=0)
    parser.add_argument('--NumLayer', type=int, default=10)
    parser.add_argument('--range_v', type=float, default=0.1)
    ...
    with open(args.config_file, 'r') as f:
        for key, value in Namespace(yaml.load(f, Loader=Loader)).__dict__.items():
            vars(args)[key] = value
